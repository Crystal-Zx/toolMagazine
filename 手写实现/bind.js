 ...
 * 3.2 bind 返回的函数称为绑定函数，它也能通过 new 操作符创建对象，而 new 绑定的对象会将 this 指向生成的实例对象。此时，bind 返回的绑定函数会丢失 this 值
 */
Function.prototype._bind = function (context) {
  
  if(typeof this !== 'function') {
    console.log("====213")
    throw new Error("Function.prototype.bind - what is trying to be bound is not a callable")
  }
  var self = this
  // 获取参数列表：获取第二个至最后一个参数
